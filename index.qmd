...
::: {#fig-network fig-cap="Interactive bipartite network"}
```{=html}
<div id="network-root" class="network-mode--embedded" style="height: 500px;">
<link rel="stylesheet" href="network-scoped.css">

<div class="canvas-wrapper" id="canvas-wrapper">
  <svg class="graph-svg" id="graph"></svg>

  <!-- Zoom controls: positioned top-left -->
...
<!-- Load core visualization module -->
<script src="network-core.js"></script>

<!-- Load embedded initialization module -->
<script src="network-embedded.js"></script>

<!-- Initialize embedded network on page load -->
<script>
// ── CONFIGURATION: Modify this to specify which network to display ──
const NETWORK_CONFIG = {
  file: "networkjson/260630-1208_A100_M5_tmax100_op1_FS_seed354_gpt_t100.json",
  type: "AS",  // "AS" (bipartite), "AA" (agent projection), or "SS" (statement projection)
  layout: {
    spread: 100,    // Repulsion force
    edgelen: 10,    // Edge/spring rest distance
    attract: 0.75   // Attraction force strength
  }
};
// ────────────────────────────────────────────────────────────────────

document.addEventListener('DOMContentLoaded', () => {
  // Initialize embedded network
  initEmbedded('canvas-wrapper', NETWORK_CONFIG);
});
</script>
</div>
```
